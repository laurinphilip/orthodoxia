...
- 28 historische Schriften der Kirchenväter: 15 deutsche und 13 englische
- gestaltete Heiligenbibliothek mit Themenfiltern, Suche und persönlicher Leseliste
- direkte PDF- und Leselinks zu transparent benannten Originalquellen
...
Nach dem Entpacken muss dein Repository so aussehen:
    ...
    ├── robots.txt
    ├── README.md
    ├── BIBLIOTHEK-GITHUB-ANLEITUNG.md
    ├── .nojekyll
    ├── css/
    │   ├── style.css
    │   └── library.css
...
4. Öffne den neu entstandenen Ordner.
